...
start "Eureka Server (Port 8761)" cmd /c "cd /d %~dp0fixmate-eureka-server && title Eureka Server && mvn spring-boot:run"
...
start "API Gateway (Port 8080)" cmd /c "cd /d %~dp0fixmate-api-gateway && title API Gateway && mvn spring-boot:run"
