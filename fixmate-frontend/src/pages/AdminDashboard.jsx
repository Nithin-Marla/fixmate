...
import { Users, Briefcase, FileCheck2, CheckCircle2, Siren, IndianRupee, ShieldAlert } from 'lucide-react'
        ...
        <>
          <div className="grid grid-3" style={{ marginBottom: '1.5rem' }}>
            ...
            <StatCard
              ...
              value={`₹${Number(analytics.totalRevenue || 0).toLocaleString('en-IN', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`}
            ...
            <StatCard
              ...
              sub="instant requests fulfilled"
              color="var(--danger)"
              bg="var(--danger-light)"
            />
          </div>
